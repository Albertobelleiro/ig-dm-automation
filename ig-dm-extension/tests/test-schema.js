...
assert('Has handleReset', popupJsContent.includes('async function handleReset'));
assert('Has handleReload', popupJsContent.includes('async function handleReload'));
assert('Has sendWithTimeout', popupJsContent.includes('function sendWithTimeout'));
assert('Has pingContentScript', popupJsContent.includes('async function pingContentScript'));
...
assert('Has scripting permission', manifest.permissions.includes('scripting'));
assert('Has webNavigation permission', manifest.permissions.includes('webNavigation'));
